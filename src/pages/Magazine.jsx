...
const features = [
  {
    ...
    description:
      "Compelling narratives from students sharing their journeys, challenges, and triumphs throughout their academic life.",
  },
  {
    icon: Award,
    title: "Academic Excellence",
    description:
      "Highlighting scholarly achievements, research breakthroughs, and academic milestones of our community members.",
  },
  {
    icon: Lightbulb,
    title: "Creative Expressions",
    description:
      "A platform for artistic talents including poetry, artwork, photography, and creative writing from our students.",
  },
  {
    icon: Users,
    title: "Community Voices",
    description:
      "Interviews, opinion pieces, and discussions that reflect the diverse perspectives within our institution.",
  },
  {
    icon: GraduationCap,
    title: "Innovations & Milestones",
    description:
      "Documenting technological innovations, project showcases, and significant milestones achieved by students.",
  },
  {
    icon: BookOpen,
    title: "Campus Chronicles",
    description:
      "Coverage of events, festivals, workshops, and memorable moments that define our campus culture.",
  },
];
        ...
        <div className="relative z-10 px-6 py-12 max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="opacity-0 animate-fade-in-up delay-300 max-w-2xl mx-auto text-gray-400 text-lg leading-relaxed">
              Our student magazine is a celebration of creativity, achievement,
              and the vibrant voices that make up our college community. Each
              edition captures the essence of student life, academic pursuits,
              and the inspiring journeys of our peers.
            </p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              <div className="flex-1">
                ...
                <p className="text-gray-400 leading-relaxed mb-4">
                  The SHAIDS Magazine has been the voice of our student
                  community for years, serving as a platform for expression,
                  documentation, and celebration of achievements.
                </p>
                <p className="text-gray-400 leading-relaxed">
                  From thought-provoking articles to stunning visual content,
                  our magazine showcases the multifaceted talents of our student
                  body while preserving the memories and milestones that define
          ...
          <div className="mb-8 opacity-0 animate-fade-in-up delay-500">
            ...
            <p className="text-gray-500 text-center">
              Explore the diverse content within our pages
            </p>
          </div>
          ...
          <div
            className="mt-16 text-center opacity-0 animate-fade-in delay-600"
          ...
          >
            <div className="inline-flex flex-col items-center glass-card px-8 py-6">
              ...
              <p className="text-gray-400 text-sm">
                New editions released every semester
              </p>
            </div>
          </div>
        </div>
