...
function FlipCard({ title, description, href, icon: Icon, delay }) {
  return (
    <Link
      to={href}
      className={`flip-card w-full sm:w-80 h-72 opacity-0 animate-fade-in-up ${delay}`}
    >
      <div className="flip-card-inner">
        <div className="flip-card-front glass-card flex flex-col items-center justify-center p-8">
          ...
          <div className="mt-4 flex gap-1">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="w-2 h-2 rounded-full bg-[#4a90d9]/50" />
            ))}
          </div>
        </div>
...
export default function Home() {
  return (
    <div className="bg-bgGradient">
      <Navbar show={true} />
      <div className="min-h-screen navy-gradient relative overflow-hidden mt-2">
          ...
          <div className="text-center mb-16">
            <div className="opacity-0 animate-fade-in-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-8">
                ...
                <span className="text-sm text-gray-400 animate-text-shimmer">
            ...
            <h1 className="opacity-0 animate-fade-in-up delay-100 text-5xl sm:text-7xl font-black text-white tracking-tight mb-6 text-3d">
              SHAIDS
              <span className="block text-[#6dd5ed] text-3d-cyan">
                ACHIEVERS
              </span>
            </h1>
