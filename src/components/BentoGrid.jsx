    ...
    >
      {bgImage && (
        <div className="absolute inset-0 z-0 overflow-hidden flex items-center justify-center">
          ...
          />
          <div
            className={`absolute inset-0 bg-gradient-to-t from-[#020617]/60 md:from-[#020617]/60 ${isLogo ? "via-transparent" : "via-blue-950/40 md:via-blue-950/40"} to-transparent`}
          />
      ...
      <div
        className={`absolute inset-0 rounded-[10px] md:rounded-xl border border-white/0 group-hover:border-blue-400/30 transition-all duration-1000 ${isHighlighted ? "border-blue-400/20" : ""} group-hover:shadow-[0_0_30px_rgba(37,99,235,0.1),inset_0_0_20px_rgba(37,99,235,0.1)]`}
      />
